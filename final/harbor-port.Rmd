...
In this assignment I used discrete-event simulation library simmer to create a simulation,
I was unsucessfull in creating a full simulation as per problem statment but 

I was able to create some other simple simulations which can be found on my github account [(https://github.com/electron0zero/R-projects/tree/master/hospital_simulation)](https://github.com/electron0zero/R-projects/tree/master/hospital_simulation)
